...
<body>
	<header style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('surowono.jpg'); margin-bottom: 860px;">
		<div class="nav">
	...
	<div class="main">
      ...
      <?php
            $no=0;
            $result = mysqLi_query($koneksi2,"SELECT * FROM tbdetailwisata WHERE kategori = 'Candi' ORDER BY nm_wisata ASC");
