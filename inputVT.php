...
<head>
	...
	<title>Input Data Virtual Tour</title>
...
<body>
	<div class="conteiner" style="margin-left: 300px; margin-right: 300px;">
		...
		<form action="prosesInputVT.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
			<div class="form-group">
				<label>Nama Wisata</label>
				<input type="text" class="form-control" name="nm_wisata" id="nm_wisata" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="vt" required>
			</div>
